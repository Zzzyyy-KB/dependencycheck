...
import edu.zju.cst.aces.sootex.callgraph.DirectedCallGraph;
import edu.zju.cst.aces.sootex.common.NumberableComparator;
import edu.zju.cst.aces.sootex.common.SortedArraySet;
...
public class SootUtils {
	...
	public static void doRTAPointsToAnalysis(Map<String,String> opt) {
		...
		LOGGER.info("[RTA] Done!");
	}

	public static void doVTAPointsToAnalysis(Map<String,String> opt) {
		LOGGER.info("[VTA] Starting analysis ...");

		HashMap<String,String> defaultOptions = new HashMap<String,String>();
		defaultOptions.put("enabled", "true");
		defaultOptions.put("vta", "true");
		defaultOptions.put("verbose", "true");
		defaultOptions.put("propagator", "worklist");
		defaultOptions.put("simple-edges-bidirectional", "false");
		defaultOptions.put("on-fly-cg", "false");
	...
	public static void doSparkPointsToAnalysis(Map<String,String> opt) {
		...
		defaultOptions.put("all-reachable","true");
	 ...
	 */
	public static Collection<SootMethod> getAllImplementors(FastHierarchy hierarchy, SootMethod method) {
		...
		while (!workList.isEmpty()) {
			...
			if (curClass.isInterface()) {
				workList.addAll(hierarchy.getAllImplementersOfInterface(curClass));
				workList.addAll(hierarchy.getAllSubinterfaces(curClass));
			} else
	 ...
	 */
	public static Set<SootClass> getAllChildClasses(FastHierarchy hierarchy, SootClass sc) {
		List<SootClass> workList = new ArrayList<SootClass>();
		workList.add(sc);
		Set<SootClass> doneSet = new HashSet<SootClass>();
