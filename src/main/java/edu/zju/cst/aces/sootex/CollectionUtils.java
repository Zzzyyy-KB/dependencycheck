...
public class CollectionUtils {
    ...
    public static Collection<Object> search(Iterator<?> it, ElementMatcher matcher){
	...
	/**  Return the intersected original set, all a new set. 
	 *   The operation is determined by set size, and proportion of set size.
 	 */
	public static Set<?> intersectWith(Set<?> workingset,final Set<?> intersected){
		final int TIMES = 20;    
